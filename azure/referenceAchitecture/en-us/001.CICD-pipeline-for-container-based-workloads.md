...
<img src="../img/001.deploymain"></img>
> Sp Clint Id : "appId" of previous step
> Sp Clint Secret : ""password" of previous step
> Linux Admin Username & Password : Now, you should define.
> Linux SSH Public Key : We already make it in previous step. Type the command on cloud shell <code>cat ~/.ssh/id_rsa.pub</code>
> Kubernetes Version : Type as you know.
